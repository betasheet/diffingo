...
class File {
 public:
   ...
   */
  void setImplementationFilename(const std::string &filename);
  ...
  */
  std::string filenameImplementation() const;
   ...
   */
  void addCopyright(int year, const std::string &name,
                    const std::string &email);

  /**
   * Returns the list of all copyright statements.
   */
  std::list<std::string> copyrightStrings() const;
  ...
  /**
   * Inserts a class to the file. Returns pointer to inserted class.
   */
  Class *insertClass(const Class &newClass);
  ...
  /**
   * Adds a file @param variable to the file. Returns pointer to added variable.
   */
  Variable *addFileVariable(const Variable &variable);
  ...
  /**
   * Adds a file @param function to the file. Returns pointer to added function.
   */
  Function *addFileFunction(const Function &function);
  ...
  /**
   * Adds a file enum to the file. Returns pointer to added enum.
   */
  Enum *addFileEnum(const Enum &enumValue);
   ...
   */
  void addExternCDeclaration(const std::string &externalCDeclaration);

  /**
   * Returns the list of all external C declarations.
   */
  std::list<std::string> externCDeclarations() const;

  /**
   * Adds a file @param code block to the file. Returns pointer to added code.
   */
  Code *setFileCode(const Code &code);

  /**
   * Returns pointer to the file code block.
   */
  Code *fileCode() const;

  /**
   * Adds a header @param code block to the file. Returns pointer to added code.
   */
  Code *setHeaderCode(const Code &code);

  /**
   * Returns pointer to the header code block.
   */
  Code *headerCode() const;
